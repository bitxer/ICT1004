 <form name="frmRegistration" method="post" action="/register/register_process">
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" title="This will be your profile name." class="form-control" required name="loginid" id="loginid" value="<?php if (isset($_POST['loginid'])); ?>">
                </div>
            </div>
            <div class="form-group">
                <label>Name</label>
                <div>
                    <input type="text" title="Your full name." class="form-control" required id="name" name="name" value="<?php if (isset($_POST['name'])); ?>">
                </div>
            ...
            <div class="form-group">
                <label>Email</label>
                <div>
                    <input type="text" class="form-control" required pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" id="email" name="email" value="<?php if (isset($_POST['email'])); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    <button type="submit" id="register-user" name="register-user" value="Register" class="btn btn-primary">Register</button>
                </div>
                <?php
                    if (isset($_GET['error'])){
