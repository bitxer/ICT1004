<div class="card" id="contactus">
    <form class="contactus card-body" id="contact" method="post" action="/main/contact_us">
        ...
        <section class="form-group">
            <input class="form-group col-sm" type="text" name="fullname" required>
        </section>

        <label>Email:</label>
        <section class="form-group">
            <input class="form-group col-sm" type="text" name="email" value="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
        </section>

        <label>Description:</label>
        <section class="form-group">
            <textarea class="form-group col-sm" type="text" name="description" rows="6" cols="50" required></textarea>
        </section>
